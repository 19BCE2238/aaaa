...
<body>
  ...
  <section class="home-section">
	...
	<center>
		...
		?>
	<h2 style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">Fallsem details</h2></html>
...
<table border="2">
  ...
  <?php
$records = mysqli_query($conn,"select * from fallsem");
...
?>
  ...
  <script>
function fallsem(){
    document.getElementById('main1').innerHTML="<p>hi</p>";
}
